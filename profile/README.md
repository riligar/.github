...
**R$ 0 para começar** — sem cartão, sem contrato.

Cada produto publica um `llms.txt` e um servidor **MCP**: aponte seu agente e ele integra sozinho.

Operação de uma pessoa, por escolha. Você fala com quem escreveu o código, em português.
